    ...
    <nav className="fixed top-0 left-0 w-full z-50 text-white p-2 px-6  bg-[#00000072] ">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-20 font-semibold text-lg">
          <Link to="/">Home</Link>
          <Link to="/beyond/speaker">Speakers</Link>
          <Link to="/beyond/agenda">Agenda</Link>
          <Link to="/beyond/faq">FAQ</Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden mt-4 flex flex-col gap-4 font-semibold text-lg bg-black/70 p-4 rounded-lg backdrop-blur-md">
          ...
          <Link to="/beyond/speakers" onClick={() => setIsOpen(false)}>
            Speakers
          </Link>
          <Link to="/beyond/agenda" onClick={() => setIsOpen(false)}>
            Agenda
          </Link>
          <Link to="/beyond/faq" onClick={() => setIsOpen(false)}>
            FAQ
          </Link>
